...
host was blocked by the build environment's network policy. Import real bars through the
CSV tab (`symbol,date,open,high,low,close,volume`, 130+ sessions per symbol) or use the
